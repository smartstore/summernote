...
export var summernote_global_config = {
  ...
  popover: {
    image: [
      ['custom', ['imageAttributes', 'link', 'unlinkImage', 'unlink', 'imageShapes']],
  ...
  icons: {
    ...
    //'flipV': '<svg viewBox="0 0 14 14"><path d="M3.5 7v1h1v-1h-1zm4 4v1h1v-1h-1zm2-14H4a1 1 0 0 0-1 1v2h1V1h8v2h1V1a1 1 0 0 0-1-1zm1 14H6v1a1 1 0 0 0 1-1zm-7-3v1h1v-1H3zm5 3v1h1v-1H8zm3-2v1h1v-1h-1zm-8 4v1h1v-1H3zm2 1v1h1v-1H5z" fill-rule="nonzero"/></svg>',
