...
export default class ImageDialog {
  ...
  bindEnterKey($btn) {
    this.$dialog.find('.note-input').on('keypress', (e) => {
  ...
  showImageDialog(imgInfo) {
    var $imageUrl = this.$dialog.find('.note-image-src');
    var $imageClass = this.$dialog.find('.note-image-class');
    var $imageStyle = this.$dialog.find('.note-image-style');
    var $imageAlt = this.$dialog.find('.note-image-alt');
    var $imageTitle = this.$dialog.find('.note-image-title');
    var $imageBtn = this.$dialog.find('.note-image-btn');
    var $imageBrowse = this.$dialog.find('.btn-browse');
